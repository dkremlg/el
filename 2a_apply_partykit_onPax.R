...
write.csv(Data,paste0(path,'R_Output_Training_Pax.csv'),row.names=FALSE)

Forecast_Data=read.csv(paste0(path,'R_Test_Pax.csv'))
...
write.csv(Forecast_Data,paste0(path,'R_Output_Test_Pax.csv'),row.names=FALSE)