...
Data=read.csv('/home/ubuntu/Data/Intermediate_Output/R_Training_Pax.csv')
...
write.csv(Data,'/home/ubuntu/Data/Intermediate_Output/R_Output_Training_Pax.csv',row.names=FALSE)

Forecast_Data=read.csv('/home/ubuntu/Data/Intermediate_Output/R_Test_Pax.csv')
...
write.csv(Forecast_Data,'/home/ubuntu/Data/Intermediate_Output/R_Output_Test_Pax.csv',row.names=FALSE)
